...
const HeroSection = () => {
  ...
  return (
    <section 
      ...
      style={{ 
        background: "linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.65)), url('https://images.unsplash.com/photo-1589939705384-5185137a7f0f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&h=1080&q=80') center/cover no-repeat"
      }}
    >
